...
class SquadExample(object):
    ...
    def __repr__(self):
        # s=""
        s = {"uuid": tokenization.printable_text(self.uuid),
             "question_text": tokenization.printable_text(self.question_text),
             "doc_tokens": " ".join(self.doc_tokens), "start_position": self.start_position,
...
if __name__ == '__main__':
    ...
    with open('./dataset_wordpiece/dev_examples.pkl', 'wb') as p:
        json.dump(list(dev_examples), p)
    with open('./dataset_wordpiece/dev_features.pkl', 'wb') as p:
        json.dump(list(dev_features), p)
